...
def play():
    '''
    # moved images here bc of testing import error
    left_glow_arrow_image = load_image("../images/left_arrow_glow.png")
    left_glow_arrow_image = scale_image(left_glow_arrow_image, ARROW_WIDTH, ARROW_HEIGHT)

    right_glow_arrow_image = load_image("../images/right_arrow_glow.png")
    right_glow_arrow_image = scale_image(right_glow_arrow_image, ARROW_WIDTH, ARROW_HEIGHT)

    up_glow_arrow_image = load_image("../images/up_arrow_glow.png")
    up_glow_arrow_image = scale_image(up_glow_arrow_image, ARROW_WIDTH, ARROW_HEIGHT)

    down_glow_arrow_image = load_image("../images/down_arrow_glow.png")
